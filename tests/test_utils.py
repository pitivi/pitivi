...
class TestBeautifyTime(TestCase):
    ...
    def check_beautify_last_updated_timestamp(self, seconds, expected):
        """Checks beautification of project's updation timestamp."""
        time.time = Mock()
    ...
    def test_beautify_last_updated_timestamp(self):
        ...
        self.check_beautify_last_updated_timestamp(0, "Just now")
        self.check_beautify_last_updated_timestamp(60 * 45 - 1, "Just now")

        self.check_beautify_last_updated_timestamp(60 * 45, "An hour ago")
        self.check_beautify_last_updated_timestamp(60 * 90 - 1, "An hour ago")

        self.check_beautify_last_updated_timestamp(60 * 90, "Today")
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 - 1, "Today")

        self.check_beautify_last_updated_timestamp(60 * 60 * 24, "Yesterday")
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 2 - 1, "Yesterday")

        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 2,
                                                   time.strftime("%A", time.localtime(0)))
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 7 - 1,
                                                   time.strftime("%A", time.localtime(0)))

        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 7,
                                                   time.strftime("%B", time.localtime(0)))
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 365 - 1,
                                                   time.strftime("%B", time.localtime(0)))

        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 365, "About a year ago")
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 365 * 1.5 - 1, "About a year ago")

        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 365 * 1.5, "About 2 years ago")
        self.check_beautify_last_updated_timestamp(60 * 60 * 24 * 365 * 3, "About 3 years ago")
