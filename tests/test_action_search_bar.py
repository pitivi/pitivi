...
class TestActionSearchBar(common.TestCase):
    ...
    def test_action_search(self):
        ...
        shortcut_manager.add("alpha_group.first", ["<Primary>A"], None, "First action")
        shortcut_manager.add("alpha_group.second", ["<Primary>B"], None, "Second action")
        shortcut_manager.add("beta_group.first", ["<Primary>C"], None, "First beta action")
        ...
        # When entry is "First".
        self.assertEqual(self.result_vals(action_search_bar, "First"), ["First action", "First beta action"])
