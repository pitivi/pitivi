...
class TestShiftSelection(BaseTestTimeline):
    ...
    def __reset_clips_selection(self, timeline):
        ...
        for layer in layers:
            ...
            timeline.selection.set_selection_meta_info(layer, 0, UNSELECT)
    ...
    def __check_simple(self, left_click_also_seeks=False):
        timeline_container = create_timeline_container()
        timeline = timeline_container.timeline
    ...
    def __check_shift_selection_single_layer(self, left_click_also_seeks=False):
    ...
    def __check_shift_selection_multiple_layers(self, left_click_also_seeks=False):
    ...
    def test_simple(self):
        self.__check_simple()
        self.__check_simple(True)

    def test_shift_selection_single_layer(self):
        self.__check_shift_selection_single_layer()
        self.__check_shift_selection_single_layer(True)

    def test_shift_selection_multiple_layers(self):
        self.__check_shift_selection_multiple_layers()
        self.__check_shift_selection_multiple_layers(True)
