...
class TestLayers(BaseTestTimeline):
    ...
    def test_media_types(self):
        ...
        self.assertEqual(media_types & GES.TrackType.AUDIO, False)
        self.assertEqual(media_types & GES.TrackType.VIDEO, False)
        ...
        self.assertEqual(timeline.media_types & GES.TrackType.VIDEO, False)
        ...
        ges_clip_audio = self.add_clip(ges_layer_1, 10, clip_type=GES.TrackType.AUDIO)
        ges_clip_video = self.add_clip(ges_layer_2, 20, clip_type=GES.TrackType.VIDEO)
        self.assertEqual(timeline.media_types, GES.TrackType.VIDEO | GES.TrackType.AUDIO)
