...
class EditorPerspective(Perspective, Loggable):
    ...
    def setup_ui(self):
        """Sets up the UI of Editor perspective."""
        self.setup_css()
        self._createUi()
        self.app.gui.connect("destroy", self._destroyedCb)

    def setup_css(self):
        """Sets up CSS for Editor perspective."""
    ...
    def _destroyedCb(self, unused_main_window):
        ...
        self.parent_widget.remove(self.timeline_ui)
    ...
    def _createUi(self):
        ...
        self.parent_widget = Gtk.Paned(orientation=Gtk.Orientation.VERTICAL)
        ...
        self.parent_widget.pack1(self.mainhpaned, resize=False, shrink=False)
        ...
        self.parent_widget.pack2(self.timeline_ui, resize=True, shrink=False)
        ...
        self.parent_widget.get_accessible().set_name("contents")
        ...
        self.parent_widget.set_position(self.settings.mainWindowVPanePosition)
    ...
    def _setDefaultPositions(self):
        ...
        if self.settings.mainWindowVPanePosition is None:
            ...
            req = self.parent_widget.get_preferred_size()[0]
    ...
    def create_headerbar(self):
        """Creates headerbar for Editor perspective."""
    ...
    def set_keyboard_shortcuts(self):
        """Sets up keyboard shortcuts for Editor perspective."""
    ...
    def enable_keyboard_shortcuts(self):
        """Enables Editor perspective's keyboard shortcuts."""
    ...
    def disable_keyboard_shortcuts(self):
        """Disables Editor perspective's keyboard shortcuts."""
...
# UI Callbacks
    ...
    def _saveWindowSettings(self):
        ...
        self.settings.mainWindowVPanePosition = self.parent_widget.get_position()
