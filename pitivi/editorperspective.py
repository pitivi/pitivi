...
class EditorPerspective(Gtk.Widget, Loggable):
    ...
    def setup_editor_window_ui(self):
        self.setupCss()
        self._createUi()
    ...
    def _destroyedCb(self, unused_main_window):
        ...
        self.app.gui.disconnect_by_func(self._destroyedCb)
...
# Toolbar/Menu actions callback
    ...
    def _newProjectMenuCb(self, unused_action, unused_param):
        self.app.gui.perspective_manager.show_editor_window()
        self.app.project_manager.newBlankProject()

    def _openProjectCb(self, unused_action, unused_param):
        if self.app.gui.perspective_manager.current_active_child == "editor_window":
            if not self.app.project_manager.closeRunningProject():
                return  # The user has not made a decision, don't do anything.
            self.app.gui.perspective_manager.show_greeter_window()
        else:
            BrowseProjectsDialog(self.app)
