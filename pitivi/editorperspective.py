...
class EditorPerspective(Gtk.Widget, Loggable):
    ...
    def _createUi(self):
        ...
        self._editor_menu_button.get_accessible().set_name("main menu button")
    ...
    def _create_headerbar_buttons(self):
        ...
        self._editor_menu_button = self.builder.get_object("menubutton")
        ...
        self.editor_headerbar.pack_end(self._editor_menu_button)
    ...
    def _enable_editor_keyboard_shortcuts(self):
        self.save_action.set_enabled(True)
        self.save_as_action.set_enabled(True)
        self.import_asset_action.set_enabled(True)

    def _disable_editor_keyboard_shortcuts(self):
        self.save_action.set_enabled(False)
        self.save_as_action.set_enabled(False)
        self.import_asset_action.set_enabled(False)
