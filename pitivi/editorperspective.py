...
class EditorPerspective(Gtk.Widget, Loggable):
    ...
    def _setup_editor_perspective_ui(self):
        self.setupCss()
        self._createUi()
    ...
    def _createUi(self):
        ...
        self._editor_headerbar = Gtk.HeaderBar()
        self._create_headerbar_buttons()
        self._editor_headerbar.set_show_close_button(True)
        self._editor_headerbar.show_all()
        ...
        self._editor_headerbar.get_accessible().set_name("editor_headerbar")
    ...
    def _create_headerbar_buttons(self):
        ...
        self._editor_headerbar.pack_start(back_button)
        ...
        self._editor_headerbar.pack_start(undo_redo_box)
        ...
        self._editor_headerbar.pack_end(self._editor_menu_button)
        self._editor_headerbar.pack_end(self.save_button)
        self._editor_headerbar.pack_end(self.render_button)
...
# Project management callbacks
    ...
    def updateTitle(self):
        ...
        self._editor_headerbar.set_custom_title(event_box)
    ...
    def __titleClickCb(self, unused_widget, unused_event, project):
        ...
        self._editor_headerbar.set_custom_title(entry)
