...
class EditorPerspective(Gtk.Widget, Loggable):
    ...
    def setup_editor_perspective_ui(self):
        self.setupCss()
        self._createUi()
    ...
    def _destroyedCb(self, unused_main_window):
        ...
        self.import_asset_action.disconnect_by_func(self.__import_asset_cb)
        self.disconnect_by_func(self._destroyedCb)
        self.app.gui.disconnect_by_func(self._configure_cb)
    ...
    def _createUi(self):
        ...
        self.editor_headerbar = Gtk.HeaderBar()
        self._create_headerbar_buttons()
        self.editor_headerbar.set_show_close_button(True)
        self.editor_headerbar.show_all()
        ...
        self.editor_headerbar.get_accessible().set_name("editor_headerbar")
    ...
    def _create_headerbar_buttons(self):
        ...
        back_button.set_tooltip_text(_("Close project and open greeter perspective"))
        back_button.connect("clicked", self.__back_cb)
        self.editor_headerbar.pack_start(back_button)
        ...
        self.editor_headerbar.pack_start(undo_redo_box)
        ...
        self.editor_headerbar.pack_end(self._menubutton)
        self.editor_headerbar.pack_end(self.save_button)
        self.editor_headerbar.pack_end(self.render_button)
    ...
    def _add_editor_keyboard_shortcuts(self):
        ...
        self.app.gui.add_action(self.import_asset_action)

    def _remove_editor_keyboard_shortcuts(self):
        self.app.gui.remove_action("save")
        self.app.gui.remove_action("save-as")
        self.app.gui.remove_action("menu-button")
        self.app.gui.remove_action("import-asset")
...
# Toolbar/Menu actions callback
    ...
    def __back_cb(self, unused_button):
        """Closes the current project and opens the greeter perspective."""
...
# Project management callbacks
    ...
    def updateTitle(self):
        ...
        self.editor_headerbar.set_custom_title(event_box)
    ...
    def __titleClickCb(self, unused_widget, unused_event, project):
        ...
        self.editor_headerbar.set_custom_title(entry)
