...
class GreeterPerspective(Perspective):
    ...
    def __init__(self, app):
        ...
        self.parent_widget = builder.get_object("scrolled_window")
    ...
    def setup_ui(self):
        """Sets up the UI of Greeter perspective."""
        self.setup_css()
    ...
    def setup_css(self):
        """Sets up CSS for Greeter perspective."""
    ...
    def create_headerbar(self):
        """Creates headerbar for Greeter perspective."""
    ...
    def set_keyboard_shortcuts(self):
        """Sets up keyboard shortcuts for Greeter perspective."""
