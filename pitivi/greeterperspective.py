...
"""Pitivi's Welcome/Greeter window."""
import os
...
class GreeterPerspective(Gtk.Widget):
    ...
    def setup_greeter_window_ui(self):
        """Setup the UI for Greeter window."""
        self.__setup_css()
