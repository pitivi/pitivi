...
class GreeterPerspective(Perspective):
    ...
    def __update_headerbar(self, welcome=False, projects=False, selection=False):
        ...
        self.__warnings_button.set_visible(welcome or projects if MISSING_SOFT_DEPS else False)
    ...
    def __warnings_clicked_cb(self, unused_button):
        WarningsPopOverWindow(self.app)
...
class WarningsPopOverWindow:
    ...
    def __init__(self, app):
        ...
        self.builder.add_from_file(
            os.path.join(get_ui_dir(), "warningspopoverwindow.ui"))
