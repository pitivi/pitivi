...
class GreeterPerspective(Gtk.Widget):
    ...
    def __create_headerbar_buttons(self):
        ...
        self.greeter_headerbar.pack_end(self._greeter_menu_button)
    ...
    def __destroyed_cb(self, unused_main_window):
        ...
        self.__new_project_action.disconnect_by_func(self.__new_project_cb)
        self.__open_project_action.disconnect_by_func(self.__open_project_cb)
