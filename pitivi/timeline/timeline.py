...
class Timeline(Gtk.EventBox, Zoomable, Loggable):
    ...
    def media_types(self):
        ...
        for ges_layer in self.ges_timeline.get_layers():
            ...
            if ((ges_layer.ui.media_types & GES.TrackType.AUDIO) and
                    (ges_layer.ui.media_types & GES.TrackType.VIDEO)):
                media_types |= GES.TrackType.AUDIO
                media_types |= GES.TrackType.VIDEO
                break
            elif ges_layer.ui.media_types & GES.TrackType.VIDEO:
                media_types |= GES.TrackType.VIDEO
            elif ges_layer.ui.media_types & GES.TrackType.AUDIO:
                media_types |= GES.TrackType.AUDIO
