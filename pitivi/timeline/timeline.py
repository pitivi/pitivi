...
class Timeline(Gtk.EventBox, Zoomable, Loggable):
    ...
    def __get_clips_in_between(self, last_clicked_layer,
        ...
        """Gets all clips between last and current click pos."""
        layers = self.ges_timeline.get_layers()
        cur_clicked_layer_pos = cur_clicked_layer.props.priority
        last_clicked_layer_pos = last_clicked_layer.props.priority
        ...
        for layer_pos in selected_layers_pos:
            ...
            clips.update(cur_layer.get_clips_in_interval(start, end))
