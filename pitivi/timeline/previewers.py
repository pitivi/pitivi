...
class ThumbnailCache(Loggable):
    ...
    @staticmethod
    def dbfile_name(uri):
        filename = str(os.path.getmtime(Gst.uri_get_location(uri))) + '_' + hash_file(Gst.uri_get_location(uri))
...
def get_wavefile_location_for_uri(uri):
    ...
    filename = str(os.path.getmtime(Gst.uri_get_location(uri))) + '_' + hash_file(Gst.uri_get_location(uri)) + ".wave.npy"
