...
class ClipProperties(Gtk.ScrolledWindow, Loggable):
    ...
    def __init__(self, app):
        ...
        self.menu_box.set_orientation(Gtk.Orientation.VERTICAL)
        self.menu_box.show()
    ...
    def create_menu(self):
        """Creates a menu to be displayed at the top."""
        box = Gtk.Grid()
        box.insert_row(0)
        box.insert_row(1)
        box.insert_column(0)
        box.insert_column(1)
        label = Gtk.Label(label="Select a clip on the timeline to configure its associated effects or create a new clip:")
...
class EffectProperties(Gtk.Expander, Loggable):
    ...
    def __init__(self, app, clip_properties):
        ...
        self._infobar = clip_properties.create_menu()
