...
class EffectProperties(Gtk.Expander, Loggable):
    ...
    def __init__(self, app, clip_properties):
        ...
        no_effects_label = Gtk.Label(
            _("No Effects. To apply an effect to the clip, drag it from the Effect Library."))
        ...
        infobar_separator = Gtk.Separator(orientation=Gtk.Orientation.HORIZONTAL)
        ...
        self.no_effects_box.pack_start(infobar_separator, False, False, 0)
