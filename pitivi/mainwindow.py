...
class MainWindow(Gtk.ApplicationWindow, GreeterPerspective,
    ...
    def show_greeter_perspective(self):
        ...
        if self.current_active_pers == GREETER_PERSPECTIVE:
            return
        self.__remove_current_perspective()
        self.current_active_pers = GREETER_PERSPECTIVE
    ...
    def show_editor_perspective(self):
        ...
        if self.current_active_pers == EDITOR_PERSPECTIVE:
            return
        self.__remove_current_perspective()
        self.current_active_pers = EDITOR_PERSPECTIVE
    ...
    def __remove_current_perspective(self):
        ...
        elif self.current_active_pers == EDITOR_PERSPECTIVE:
