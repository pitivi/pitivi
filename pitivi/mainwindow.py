...
class MainWindow(Gtk.ApplicationWindow, Loggable):
    ...
    def __menu_cb(self, unused_action, unused_param):
        if self.perspective == GREETER_PERSPECTIVE:
            self.greeter.menu_button.set_active(not self.greeter.menu_button.get_active())
        elif self.perspective == EDITOR_PERSPECTIVE:
            self.editor.menu_button.set_active(not self.editor.menu_button.get_active())
    ...
    def show_greeter_perspective(self):
        ...
        self.set_titlebar(self.greeter.headerbar)
        self.greeter.show_recent_projects()
        self.greeter.enable_keyboard_shortcuts()
        self.add(self.greeter.parent_widget)
    ...
    def show_editor_perspective(self):
        ...
        self.set_titlebar(self.editor.headerbar)
        self.editor.enable_keyboard_shortcuts()
        self.add(self.editor.parent_widget)
        self.log("Displaying Editor perspective.")

    def __remove_current_perspective(self):
        if self.perspective == GREETER_PERSPECTIVE:
            self.greeter.disable_keyboard_shortcuts()
            self.remove(self.greeter.parent_widget)
        elif self.perspective == EDITOR_PERSPECTIVE:
            self.editor.disable_keyboard_shortcuts()
            self.remove(self.editor.parent_widget)
