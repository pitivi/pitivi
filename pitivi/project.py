...
class Project(Loggable, GES.Project):
    ...
    @staticmethod
    def get_thumb(uri):
        """Returns project thumb, if exists, else returns the default thumb."""
        try:
            thumb = GdkPixbuf.Pixbuf.new_from_file(Project.get_thumb_path(uri, "96x54"))
        except GLib.Error:
    ...
    def get_assets_uri(self):
        """Returns a list of URIs of all the assets in the project."""
        return [source.get_info().get_uri() for source in self.listSources()]
