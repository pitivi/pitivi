...
class Project(Loggable, GES.Project):
    ...
    def __remove_thumbs(self):
        ...
        try:
            ...
            os.remove(self.get_thumb_path(self.uri, ORIGINAL_THUMB_DIR))
            # Scaled project thumbnail.
            os.remove(self.get_thumb_path(self.uri, SCALED_THUMB_DIR))
    ...
    def create_thumb(self):
        ...
        if normal_thumb_path or large_thumb_path:
            ...
            # Maybe user removed all the assets in the project,
            # so remove the existing project thumbnails, if any.
