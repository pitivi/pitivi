...
class ViewerContainer(Gtk.Box, Loggable):
    ...
    def _entryActivateCb(self, unused_entry):
        ...
        self.app.gui.main_window.timeline_ui.timeline.scrollToPlayhead(align=Gtk.Align.CENTER, when_not_in_view=True)
    ...
    def _goToStartCb(self, unused_button):
        ...
        self.app.gui.main_window.focusTimeline()
        self.app.gui.main_window.timeline_ui.timeline.scrollToPlayhead(align=Gtk.Align.START, when_not_in_view=True)
    ...
    def _backCb(self, unused_button):
        ...
        self.app.gui.main_window.focusTimeline()
        self.app.gui.main_window.timeline_ui.timeline.scrollToPlayhead(align=Gtk.Align.END, when_not_in_view=True)
