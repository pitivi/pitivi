...
class Overlay(Gtk.DrawingArea, Loggable):
    ...
    def _select(self):
        ...
        self.stack.app.gui.main_window.timeline_ui.timeline.selection.setSelection([self._source], SELECT)
        if isinstance(self._source, GES.TitleSource):
            ...
            return
        self.stack.app.gui.main_window.context_tabs.set_current_page(page)
