...
class PeakMeter(Gtk.DrawingArea):
    ...
    def __draw_bar(self, context, bar_width, bar_height):
        peak_height = self.__normalize_peak(self.peak)
    ...
    def __draw_cells(self, context, bar_width, bar_height):
    ...
    def __normalize_peak(self, peak):
        bar_height = self.__get_bar_height()
