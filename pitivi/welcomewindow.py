...
class WelcomeWindow(Gtk.Widget):
    ...
    def show_recent_projects(self):
        ...
        recent_items = self.__app.recent_manager.get_items()
    ...
    def __create_headerbar_buttons(self):
        ...
        browse_projects_button = Gtk.Button.new_with_label(_("Browse Projects"))
        browse_projects_button.connect("clicked", self.__browse_projects_cb)
        ...
        self.headerbar.pack_start(browse_projects_button)
    ...
    def __browse_projects_cb(self, unused_button):
        """Handles a click on the Browse Projects button."""
