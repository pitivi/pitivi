...
class InteractiveIntro(GObject.Object):
    ...
    def create_intro_button(self):
        ...
        img.set_name("pitivi-icon")
        intro_button = Gtk.Button()
        intro_button.set_image(img)
        intro_button.set_name("highlight-widget")
    ...
    def show_control_popover(self):
        ...
        self.intro_label.set_property("margin", 4)
        ...
        self.overview_button.set_label(overview_label)
        self.overview_button.set_property("margin", 10)
    ...
    def interactive_overview_show_popup_func(self):
        ...
        if self.current_widget_index > 0:
            ...
            prev_widget.set_name("")
        widget.set_name("highlight-widget")
        self.intro_label.set_markup("{}".format(text))
...
@keyframes icon-highlight {
  from { -gtk-icon-shadow: 4px -1px 8px alpha(@warning_color, 0); }
  to   { -gtk-icon-shadow: 4px -1px 8px alpha(@warning_color, 0.9); }
}

#highlight-widget{
animation: widget-highlight 1.5s infinite alternate;
}
