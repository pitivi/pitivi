...
class InteractiveIntro(GObject.Object):
    ...
    def headerbar_overview(self):
        if len(self.widgets_list) == 0:
            widgets_list = [(self.app.gui.editor.intro_button, _("Let's begin with quick overview")),
    ...
    def viewer_overview(self):
        if len(self.widgets_list) == 0:
            widgets_list = [(self.app.gui.editor.viewer, _("This is your \nmedia playback.")),
    ...
    def timeline_overview(self):
        if len(self.widgets_list) == 0:
            widgets_list = [(self.app.gui.editor.timeline_ui.timeline, _("Here is your timeline.")),
    ...
    def medialibrary_overview(self):
        ...
        if len(self.widgets_list) == 0:
            widgets_list = [(self.app.gui.editor.medialibrary, _("Here you can view \n your imported media.")),
    ...
    def effectlist_overview(self):
        if len(self.widgets_list) == 0:
            widgets_list = [(self.app.gui.editor.effectlist, _("Here you have all your \n Effects and Filters.")),
    ...
    def interactive_overview_show_popup(self):
        if self.current_widget_index == len(self.widgets_list):
            self.intro_popover.popdown()
            self.current_widget_group_index += 1
            self.emit("run-next-intro", None)
            return False
        current_intro_element = self.widgets_list[self.current_widget_index]
        widget_index = 0
        label_index = 1
