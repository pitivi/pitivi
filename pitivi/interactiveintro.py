...
@keyframes intro-highlighted {
  from { box-shadow: 0px 0px 10px #9fddfc, inset 0px 0px 4px  #9fddfc; }
  to   { box-shadow: 0px 0px 4px  #9fddfc, inset 0px 0px 10px #9fddfc; }
}
...
class InteractiveIntro(GObject.Object):
    ...
    def _create_tips(self):
        ...
        return [(InteractiveIntro.intro_button, _("Let's begin with quick overview"), 3000),
                ...
                (InteractiveIntro.intro_button, _("For more productivity we have shortcuts for you Just press [ctrl]+F1 to see"), 3500),
                (InteractiveIntro.intro_button, _("For additional Help you can also refer to User Manual provided"), 3500),
                (InteractiveIntro.intro_button, _("Good Bye!"), 2000)
                ]
    ...
    def create_intro_button(self):
        ...
        InteractiveIntro.intro_button = intro_button
        return intro_button
    ...
    def show_control_popover(self):
        ...
        InteractiveIntro.intro_button.show()

        self.select_intro_popover = Gtk.Popover()
        self.select_intro_popover.add(vbox)
        self.select_intro_popover.set_relative_to(InteractiveIntro.intro_button)
    ...
    def stop_tour(self):
        ...
        self.current_widget_index = 0
        self.advance_handler_id = 0
        InteractiveIntro.intro_button.hide()
