...
@keyframes intro-highlighted {
  from { box-shadow: 0px 0px 10px #0a96d1, inset 0px 0px 4px  #0a96d1; }
  to   { box-shadow: 0px 0px 4px  #0a96d1, inset 0px 0px 10px #0a96d1; }
}
...
class InteractiveIntro(GObject.Object):
    ...
    def _create_tips(self):
        ...
        return [(self.intro_button, _("Let's begin with quick overview"), 3000),
                ...
                (self.app.gui.editor.medialibrary._import_button, _("From Here you can import your favourite media"), 3500),
