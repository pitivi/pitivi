# -*- coding: utf-8 -*-
intro_info_list = ["Let's begin with quick overview",  #Start
                   "Here Comes Your \n Project Title.",  #HeaderBar OverView
                   ...
                   "Redo Button.\n or you can press \n[ctrl]+[shift]+Z. ",
                   "Ok! now let's \nbegin with Viewer",
                   "This is your \nmedia playback. ",  #MediaPlayback OverView
                   "Seek to start",
                   "Seek back \none second",
                   "Play/Pause",
                   "Seek forward \none second",
                   ...
                   "Current position",
                   "Ok! now let's begin\n with timeline",
                   "Here is your timeline.",  #Timeline OverView
                   ...
                   "Ok, now let's\n move to media and \neffects part",
                   "Here you can view \n your imported media.",  #MediaLib OverView
