...
class MissingAssetDialog(Gtk.Dialog, Loggable):
    ...
    Attributes:
        ...
        uri: Last known URI of the missing asset.
    """
    ...
    def __init__(self, app, asset, uri):
        ...
        previewer = PreviewWidget(app.settings, discover_sync=True)
        self.chooser.set_preview_widget(previewer)
        self.chooser.set_use_preview_label(False)
        self.chooser.connect('update-preview', previewer.update_preview_cb)
        self.chooser.set_current_folder(app.settings.lastProjectFolder)
        ...
        self.chooser.add_filter(default)
